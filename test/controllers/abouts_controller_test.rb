...
class AboutsControllerTest < ActionController::TestCase
  ...
  test "should create about" do
    assert_difference('About.count') do
      post :create, about: { about: @about.about, aphon: @about.aphon, csp: @about.csp, more: @about.more, scaphon: @about.scaphon }
    end
  ...
  test "should update about" do
    patch :update, id: @about, about: { about: @about.about, aphon: @about.aphon, csp: @about.csp, more: @about.more, scaphon: @about.scaphon }
    assert_redirected_to about_path(assigns(:about))
  end
